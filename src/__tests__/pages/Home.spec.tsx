...
describe("Home", () => {
  ...
  it("should be able to render tasks as done and undone", () => {
    const { getByPlaceholderText, getAllByTestId, getByDisplayValue } = render(
      <Home />
    );
    const inputElement = getByPlaceholderText("Adicionar novo todo...");
    ...
    const buttonElement = getAllByTestId("button")[0];
    const markerElement = getAllByTestId("marker")[0];
  ...
  it("should be able to remove tasks after the trash icon was pressed", async () => {
    ...
    const firstTaskTrashIcon = getAllByTestId("trash")[0];
